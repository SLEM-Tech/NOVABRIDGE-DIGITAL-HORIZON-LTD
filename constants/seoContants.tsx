...
export const SITE_NAME = "Decaprim Tech";
export const SITE_URL =
	process.env.NEXT_PUBLIC_SITE_URL || "https://decaprim.com"; // Update with actual URL
export const TWITTER_HANDLE = "@DecaprimTech";
...
export const SEODATA: Record<string, SEOConfig> = {
	default: {
		title: `${SITE_NAME} | Decaprim Tech Ventures Limited`,
		description:
			"Decaprim Tech Ventures Limited delivers elite software engineering, AI-driven automation, and strategic digital transformation to scale global enterprises.",
		keywords: [
			"Decaprim Tech Ventures Limited",
			"Decaprim Tech",
	...
	home: {
		...
		description:
			"Build the future with Decaprim Tech. From custom mobile applications to complex AI ecosystems, we engineer high-performance products tailored to your vision.",
		keywords: [
	...
	portfolio: {
		...
		description:
			"See how Decaprim Tech Ventures Limited drives growth. Browse our case studies in fintech, healthtech, and enterprise automation.",
		keywords: [
			"Software Portfolio",
			"Tech Case Studies",
			"Success Stories",
	...
	login: {
		...
		description:
			"Access your Decaprim client dashboard to track development sprints, manage documentation, and collaborate with your team.",
		keywords: [
			"Client login",
			"Decaprim Dashboard",
			"Project tracking",
	...
	register: {
		...
		description:
			"Start your digital journey with Decaprim Tech Ventures. Register to access project resources and technical roadmaps.",
		keywords: [
			"Register Decaprim",
			"Project onboarding",
			"Tech partnership",
