...
-- Parent categories
INSERT INTO decaprim_categories (name, slug, description, parent_id, image_url, count) VALUES
...
INSERT INTO decaprim_categories (name, slug, description, parent_id, image_url, count)
...
FROM decaprim_categories WHERE slug = 'smartphones-tablets'
ON CONFLICT (slug) DO NOTHING;
...
FROM decaprim_categories WHERE slug = 'laptops-computers'
ON CONFLICT (slug) DO NOTHING;
...
FROM decaprim_categories WHERE slug = 'audio-headphones'
ON CONFLICT (slug) DO NOTHING;
...
FROM decaprim_categories WHERE slug = 'phone-accessories'
ON CONFLICT (slug) DO NOTHING;
...
INSERT INTO decaprim_products (name, slug, sku, description, short_description, price, regular_price, sale_price, stock_status, stock_quantity, rating_count, average_rating, status)
VALUES (
...
INSERT INTO decaprim_product_images (product_id, src, name, alt, position)
...
FROM decaprim_products p WHERE p.slug = 'jbl-charge-5' ON CONFLICT DO NOTHING;

INSERT INTO decaprim_product_images (product_id, src, name, alt, position)
SELECT p.id, 'https://images.unsplash.com/photo-1551816230-ef5deaed4a26?w=600', 'Apple Watch Series 9', 'Apple Watch Series 9', 0
FROM decaprim_products p WHERE p.slug = 'apple-watch-series-9-gps-45mm' ON CONFLICT DO NOTHING;
...
FROM decaprim_products p WHERE p.slug = 'samsung-galaxy-watch-6-classic-47mm' ON CONFLICT DO NOTHING;
...
FROM decaprim_products p WHERE p.slug = 'anker-67w-gan-usb-c-charger' ON CONFLICT DO NOTHING;
...
FROM decaprim_products p WHERE p.slug = 'baseus-20000mah-65w-power-bank' ON CONFLICT DO NOTHING;
...
FROM decaprim_products p WHERE p.slug = 'spigen-tough-armor-iphone-15-pro' ON CONFLICT DO NOTHING;
...
FROM decaprim_products p WHERE p.slug = 'logitech-mx-master-3s' ON CONFLICT DO NOTHING;

INSERT INTO decaprim_product_images (product_id, src, name, alt, position)
SELECT p.id, 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=600', 'Sony ZV-E10', 'Sony ZV-E10 Mirrorless Camera', 0
FROM decaprim_products p WHERE p.slug = 'sony-zv-e10-mirrorless-body' ON CONFLICT DO NOTHING;

INSERT INTO decaprim_product_images (product_id, src, name, alt, position)
SELECT p.id, 'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=600', 'GoPro Hero 12', 'GoPro HERO12 Black', 0
FROM decaprim_products p WHERE p.slug = 'gopro-hero12-black' ON CONFLICT DO NOTHING;

INSERT INTO decaprim_product_images (product_id, src, name, alt, position)
SELECT p.id, 'https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=600', 'PlayStation 5', 'Sony PlayStation 5 Console', 0
FROM decaprim_products p WHERE p.slug = 'sony-playstation-5-disc' ON CONFLICT DO NOTHING;

INSERT INTO decaprim_product_images (product_id, src, name, alt, position)
SELECT p.id, 'https://images.unsplash.com/photo-1610945264803-c22b62831e5c?w=600', 'Infinix Hot 40 Pro', 'Infinix Hot 40 Pro', 0
FROM decaprim_products p WHERE p.slug = 'infinix-hot-40-pro' ON CONFLICT DO NOTHING;

-- ── Product ↔ Category Links ──────────────────────────────────

-- Samsung Galaxy S24 Ultra → smartphones-tablets, android-phones
INSERT INTO decaprim_product_categories (product_id, category_id)
SELECT p.id, c.id FROM decaprim_products p, decaprim_categories c
...
INSERT INTO decaprim_product_attributes (product_id, name, options, position)
SELECT id, 'Storage', ARRAY['256GB', '512GB', '1TB'], 0 FROM decaprim_products WHERE slug = 'samsung-galaxy-s24-ultra' ON CONFLICT DO NOTHING;
INSERT INTO decaprim_product_attributes (product_id, name, options, position)
SELECT id, 'Color', ARRAY['Titanium Black', 'Titanium Gray', 'Titanium Violet', 'Titanium Yellow'], 1 FROM decaprim_products WHERE slug = 'samsung-galaxy-s24-ultra' ON CONFLICT DO NOTHING;

INSERT INTO decaprim_product_attributes (product_id, name, options, position)
SELECT id, 'Storage', ARRAY['256GB', '512GB', '1TB'], 0 FROM decaprim_products WHERE slug = 'apple-iphone-15-pro-max' ON CONFLICT DO NOTHING;
INSERT INTO decaprim_product_attributes (product_id, name, options, position)
SELECT id, 'Color', ARRAY['Natural Titanium', 'Blue Titanium', 'White Titanium', 'Black Titanium'], 1 FROM decaprim_products WHERE slug = 'apple-iphone-15-pro-max' ON CONFLICT DO NOTHING;

INSERT INTO decaprim_product_attributes (product_id, name, options, position)
SELECT id, 'Storage', ARRAY['128GB', '256GB'], 0 FROM decaprim_products WHERE slug = 'samsung-galaxy-a55-5g' ON CONFLICT DO NOTHING;
INSERT INTO decaprim_product_attributes (product_id, name, options, position)
SELECT id, 'Color', ARRAY['Awesome Iceblue', 'Awesome Navy', 'Awesome Lilac'], 1 FROM decaprim_products WHERE slug = 'samsung-galaxy-a55-5g' ON CONFLICT DO NOTHING;

INSERT INTO decaprim_product_attributes (product_id, name, options, position)
SELECT id, 'RAM', ARRAY['16GB', '18GB'], 0 FROM decaprim_products WHERE slug = 'apple-macbook-pro-14-m3-pro' ON CONFLICT DO NOTHING;
INSERT INTO decaprim_product_attributes (product_id, name, options, position)
SELECT id, 'Storage', ARRAY['512GB SSD', '1TB SSD', '2TB SSD'], 1 FROM decaprim_products WHERE slug = 'apple-macbook-pro-14-m3-pro' ON CONFLICT DO NOTHING;
INSERT INTO decaprim_product_attributes (product_id, name, options, position)
SELECT id, 'Color', ARRAY['Space Black', 'Silver'], 2 FROM decaprim_products WHERE slug = 'apple-macbook-pro-14-m3-pro' ON CONFLICT DO NOTHING;

INSERT INTO decaprim_product_attributes (product_id, name, options, position)
SELECT id, 'Color', ARRAY['Midnight', 'Starlight', 'Pink', 'Storm Blue', 'Green'], 0 FROM decaprim_products WHERE slug = 'apple-watch-series-9-gps-45mm' ON CONFLICT DO NOTHING;
INSERT INTO decaprim_product_attributes (product_id, name, options, position)
SELECT id, 'Size', ARRAY['41mm', '45mm'], 1 FROM decaprim_products WHERE slug = 'apple-watch-series-9-gps-45mm' ON CONFLICT DO NOTHING;

INSERT INTO decaprim_product_attributes (product_id, name, options, position)
SELECT id, 'Color', ARRAY['Phantom Black', 'Cream', 'Graphite'], 0 FROM decaprim_products WHERE slug = 'samsung-galaxy-buds2-pro' ON CONFLICT DO NOTHING;

INSERT INTO decaprim_product_attributes (product_id, name, options, position)
SELECT id, 'Color', ARRAY['Black', 'Blue', 'Red', 'Gray'], 0 FROM decaprim_products WHERE slug = 'jbl-charge-5' ON CONFLICT DO NOTHING;

-- ── Update category product counts ───────────────────────────

UPDATE decaprim_categories c
SET count = (
  SELECT COUNT(*) FROM decaprim_product_categories pc WHERE pc.category_id = c.id
);
