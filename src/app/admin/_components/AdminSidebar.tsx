  ...
  return (
    <aside className="flex flex-col h-full bg-[#002D5B] text-white w-64 shadow-2xl">
      <div className="px-6 py-6 border-b border-white/10">
        <h1 className="text-lg font-bold tracking-tight text-white">Novabridge Admin</h1>
      ...
      <div className="px-6 py-4 border-t border-white/10">
        <p className="text-[10px] text-white/30 font-medium uppercase tracking-widest">NOVABRIDGE DIGITAL HORIZON LTD</p>
      </div>
    </aside>
  );
}
