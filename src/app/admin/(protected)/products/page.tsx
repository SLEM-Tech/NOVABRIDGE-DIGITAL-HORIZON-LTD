  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex gap-3 flex-wrap">
          <input
            ...
            className="px-4 py-2.5 border border-gray-200 rounded-xl text-sm w-56 focus:outline-none focus:ring-2 focus:ring-primary-100/20 focus:border-primary-100 transition-all"
          />
          <select
            value={status}
        ...
        <div className="flex gap-2">
          <button
            ...
            className="px-4 py-2.5 bg-danger-light text-danger border border-danger/20 rounded-xl text-sm font-semibold hover:bg-red-100 whitespace-nowrap transition-colors"
          >
            Truncate All
          </button>
          <Link
            href="/admin/products/new"
            className="px-4 py-2.5 bg-success text-white rounded-xl text-sm font-semibold hover:bg-success-dark whitespace-nowrap transition-colors shadow-sm shadow-success/20"
          >
            + Add Product
          </Link>
        </div>
      ...
      <div className="flex items-center justify-between">
        <p className="text-xs font-medium text-gray-400">{data?.total ?? 0} products total</p>
