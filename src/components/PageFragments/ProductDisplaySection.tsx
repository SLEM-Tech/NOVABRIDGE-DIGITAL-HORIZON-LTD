...
const ProductDisplaySection = ({ FormatedId }: ProductDisplaySectionProps) => {
	...
	if (isLoading) {
		return (
			<section className='max-w-7xl mx-auto px-4 sm:px-6 py-10 grid grid-cols-1 lg:grid-cols-2 gap-10'>
				<Skeleton className='aspect-square w-full rounded-2xl bg-gray-100' />
				<div className='space-y-5'>
					<Skeleton className='h-5 w-32 rounded-xl bg-gray-100' />
					<Skeleton className='h-10 w-3/4 rounded-xl bg-gray-100' />
					<Skeleton className='h-8 w-1/3 rounded-xl bg-gray-100' />
					<Skeleton className='h-24 w-full rounded-xl bg-gray-100' />
					<Skeleton className='h-12 w-full rounded-2xl bg-gray-100' />
				</div>
			</section>
		);
	}
